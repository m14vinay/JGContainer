report 50212 "SOA"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Layouts/SOAReportDEV.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Cust_Address; GetFullCustAddress())
            {

            }

            column(Cust_PostCityCountyRegion; GetCustPostCityCountReg())
            {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(companyAddressFull; GetCompanyAddress())
                {
                ...
                column(MarketingCompanyPhoneNo; Companyinfo."Marketing Phone No")
                {

                }
                column(MarketingCompanyMail; Companyinfo."Marketing Email")
                {
...
#pragma warning restore AL0432
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                        ...
                        dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                If "Document Type" = "Document Type"::Invoice then begin
                                    If SalesInvoiceHeader1.Get("Detailed Cust. Ledg. Entry"."Document No.") then
                                        ExternalDocumentNo := SalesInvoiceHeader1."External Document No.";
                                End
                                else
                                    If "Document Type" = "Document Type"::"Credit Memo" then begin
                                        If SalesCrMemoHeader.Get("Detailed Cust. Ledg. Entry"."Document No.") then
                    ...
                    dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                    {
                        ...
                        column(DocDate_CustLedgEntry2; "Document Date")
                        {
                        ...
                        begin
                            ...
                            // Get External Document No by checking if Document No matches Sales Invoice/Credit Memo
                            ExternalDocumentNo2 := ''; // Initialize
                            if SalesInvoiceHeader.Get("Document No.") then
                                ExternalDocumentNo2 := SalesInvoiceHeader."External Document No."
                            else if SalesCrMemoHeader.Get("Document No.") then
                                ExternalDocumentNo2 := SalesCrMemoHeader."External Document No."
                            else
                                ExternalDocumentNo2 := "External Document No.";
    ...
    local procedure GetFullCustAddress(): Text
    begin
        exit(Format(Customer.Address + ', ' + Customer."Address 2"));
    end;

    local procedure GetCustPostCityCountReg(): Text
    var
        CountryRegion: Record "Country/Region";
        CountryName: Text;
    begin
        ...
        exit(Format(Customer."Post Code" + ', '
                  + Customer.City + ', '
                  + Customer.County + ', '
                  + CountryName));
    end;
